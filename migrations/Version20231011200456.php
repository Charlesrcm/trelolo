 ...
 */
final class Version20231011200456 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE projet ADD CONSTRAINT FK_50159CA9B981C689 FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id)');
